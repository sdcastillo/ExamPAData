#' Patient Number of Labs
#'
#' @description Data used on June 19, 2020 Exam PA
#'
#' @docType data
#'
#' @usage data("patient_num_labs")
#'
#' @format data.frame,  10000 observations of 14 variables:
#' \describe{
#'   \item{age}{Age of prospective customer. Integer from 17 to 98.}
#'   \item{job}{Occupation category. Factor with 11 levels.}
#'   \item{marital}{Marital status. Factor with levels divorced, married, and
#'         single}
#'   \item{housing}{Indicates whether the prospect has a housing loan. Factor
#'         with levels no, yes.}
#'   \item{loan}{Indicates whether the prospect has a consumer loan. Factor with
#'         levels no, yes.}
#'   \item{phone}{The type of phone the prospect uses. Factor with levels
#'         cellular, landline.}
